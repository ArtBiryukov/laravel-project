    ...
    <header>
        ...
        <div class="nav-scroller bg-body shadow-sm mb-3">
            <nav class="nav" aria-label="Secondary navigation">
                <p class="d-flex align-items-center justify-content-center text-black px-3">Категории: </p>
                <a class="nav-link" href="#">Мировые</a>
                <a class="nav-link" href="#">Финансовые</a>
                <a class="nav-link" href="#">Игровые</a>
    ...
    <main class="container pb-5">
        ...
        <div class="news__content">
            <article class="card p-3">
                ...
                <div class="card-content text-description mb-3">
                    <img class="card-img mb-4" src="https://images.unsplash.com/photo-1585829365295-ab7cd400c167?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=80&raw_url=true&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170" alt="post__photo">
                    <p class="cart-text">
                        ...
                        интегрирован практически в любой существующий дизайн, и не имеет никаких ограничений по созданию шаблонов для него. Еще одной ключевой
                        особенностью DataLife
                    </p>

                </div>

                <div class="card-bottom d-flex justify-content-between align-items-center">
                    <a href="/" title="Читать подробнее" class="btn btn-outline-primary">Подробнее</a>
